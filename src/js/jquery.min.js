...
var arrLang = {
  pl: {
    ...
    why_as: 'Czemu my?',
    why_as_description:
      'Nasze profesjonalne manikiurzystki dołożą wszelkich starań, aby uspokoić i ukoić Twoje ciało i umysł! Wybierz dowolny kolor swojego nail luxa, a my sprawimy, że zadziała dla Ciebie!Przy każdym manicure na dłonie, stopy i skórki nakładamy wyłącznie nasz organiczny olejek do ciała oraz ręcznie robiony, pozbawiony pestek olejek do skórek. Oprócz usług żelowych i akrylowych oferujemy również farby proszkowe, zabiegi organiczne oraz 5 darmowych lakierów do paznokci dla klientów dbających o środowisko.',
    why_as_button: 'dowiedsie wencej',
    maniqur: 'manicure',
    maniqur_deskription:
      'Chociaż pielęgnacja dłoni i paznokci zwykle ogranicza się do zaledwie kilku usług, mamy szeroki wybór różnych technik pedicure, a także ogólnych zabiegów na dłonie...',
    pediqur: 'pedicure',
    pdiqur_deskriptione:
      'Dobra pielęgnacja stóp i paznokci to podstawa. Świadczymy niezrównane usługi inspirowane spa, aby odświeżyć Twoje zdrowie i poprawić estetykę...',
    curses: 'kursy',
    curses_deskriptione:
      'Chociaż pielęgnacja dłoni i paznokci zwykle ogranicza się do zaledwie kilku usług, mamy szeroki wybór różnych technik pedicure, a także ogólnych zabiegów na dłonie...',
    galeri_header:'nasza praca',
    more:'więcej',
    header_price:'koszt usługi',
    price_m_1:'Manicure + wyrównywanie + malowanie jednokolorowe (2 godziny)',
    price_m_2:'Wzmocnienie żelem/płynnym poliżelem',
    price_m_3:'Wzmocnienie poliżelem',
    price_m_4:'Manicure francuski/ombre',
    price_m_5:'Rozszerzenie 1-2 długość',
    price_m_6:'Rozszerzenie 3-4 długość',
    price_m_7:'Higieniczny manicure',
    price_m_8:'Usuwanie lakieru hybrydowego bez stylizacji',
    price_m_9:'Usuwanie żelu',
    price_m_10:'Projekt',
    price_p_1:'Pedicure (pokryte palce)',
    price_p_2:'Pedicure całej stopy z powłoką',
    price_p_3:'Pedicure całej stopy bez powłoki',
    m_p:'manicure + pedicure ekspresowy',
    m_p_1:'Mistrz + Najlepszy Mistrz',
    m_p_2:'Najlepszy Mistrz + Instruktor',
    about_me:'kilka słów o sobie',
    about_me_deskription:'',
  },
  ua: {
    mean: 'Головна',
    about: 'Про нас',
    ...
    why_as: 'Почему мы?',
    why_as_description:
      'Наши профессиональные мастера маникюра сделают все возможное, чтобы успокоить и успокоить ваше тело и разум! Выбирайте любой цвет вашего nail lux — и мы заставим его работать на вас При каждом маникюре мы наносим на руки, ноги и кутикулу только наше органическое масло для тела и масло для кутикулы ручной работы без косточек. В дополнение к гелевым и акриловым услугам мы также предлагаем порошковые краски, органические процедуры и 5 бесплатных лаков для ногтей для экологически сознательных клиентов.',
    why_as_button: 'узнать больше',
    maniqur: 'манiкюр',
    maniqur_deskription:
      'У той час як догляд за руками та нігтями зазвичай обмежується всього кількома послугами, у нас є широкий вибір різних методів педикюру, а також загальні процедури догляду за шкірою рук...',
    pediqur: 'педiкюр',
    pdiqur_deskriptione:
      "Хороший догляд за ногами та нігтями має важливе значення. Ми надаємо неперевершені послуги, викликані SPA, для освіження вашого здоров'я та покращення вашої естетики.",
    curses: 'курси',
    curses_deskriptione:
      'У той час як догляд за руками та нігтями зазвичай обмежується всього кількома послугами, у нас є широкий вибір різних методів педикюру, а також загальні процедури догляду за шкірою рук.',
    galeri_header:'наші роботи',
    more:'більше',
    header_price:'вартість послуг',
    price_m_1:'Mанікюр + вирівнювання + однотонне покриття (2 години)',
    price_m_2:'Зміцнення гелем/рідким полігелем',
    price_m_3:'Зміцнення полігелем',
    price_m_4:'Манікюр френч/омбре',
    price_m_5:'Нарощування 1-2 довжина',
    price_m_6:'Нарощування 3-4 довжина',
    price_m_7:'Манікюр гігеїнічний',
    price_m_8:'Зняття гель-лаку без стилізації',
    price_m_9:'Зняття гелю',
    price_m_10:'Дизайн',
    price_p_1:'Педикюр (пальчики з покриттям)',
    price_p_2:'Педикюр всієї стопи з покриттям',
    price_p_3:'Педикюр всієї стопи без покриття',
    m_p:'манікюр+педикюр express',
    m_p_1:'Майстер + Топ-Майстер',
    m_p_2:'Топ-Майстер + Інструктор',
    about_me:'трохи про мене',
    about_me_deskription:'',
  },
};
